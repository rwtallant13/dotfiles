...
local color_solid = beautiful.bg_normal .. 80
...
local widget = function(inner_widget)
    return wibox.widget {
        ...
        top = dpi(beautiful.bar_item_padding ),
        bottom = dpi(beautiful.bar_item_padding ),
        left = dpi(6),
        right = dpi(6),
        {
            inner_widget,
...
local layoutbox = require("widgets.topbar.layoutbox")
