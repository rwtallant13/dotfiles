...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey, altkey          }, "b",
		function () awful.spawn(incognito_browser) end,
    ...
    awful.key({ }, "Print",
		function () awful.spawn(screenshot .. " gui", false) end,
    ...
    awful.key({modkey }, "Print",
		function () awful.spawn(screenshot .. " screen -c", false) end,
		{description = "Screenshot current screen", group = "launcher"}
	),

	awful.key({ modkey }, "m",
		function () awful.spawn(terminal .. "-e zsh -ic 'vifm /home/rob/downloads/ /drives/blueberry/'", false) end,
		{description = "Vifm for media", group = "launcher"}
	),

	awful.key({ modkey }, "f",
		function () awful.spawn(terminal .. "-e zsh -ic 'vifm '", false) end,
	...
	awful.key({ modkey }, "F1",
		function () awful.spawn("/home/rob/bin/red.sh -t /home/rob/.config/redshift/dim.conf" ) end,
